...
<?php
	if (isset($_POST['redirect']) && !empty($_POST['redirect']) && $_POST['redirect'] == 'redirect')
	{
		...
		//header( 'Location: http://lindacarlstad.se/account/register_success?token=' . urlencode($token) );
		/*
		echo $response;
		print_r($response);
		echo $items;
...
?>
				...
				<button type="submit" value="submit" name="submit"><img src='https://www.paypal.com/en_US/i/btn/btn_xpressCheckout.gif' /></button>
