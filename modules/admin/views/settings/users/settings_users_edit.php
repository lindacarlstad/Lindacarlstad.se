<?php defined('SYSPATH') or die('No direct script access.');?>
	...
	<h2>Create user</h2>
	<form action="" method="post" enctype="multipart/form-data" class="half center">
		<fieldset>
...
?>
		...
		<fieldset>
			<legend>Image</legend>
			<div><img src="/images/users/<?php echo Arr::get($values, 'image', 'user_standard'); ?>.jpg" alt="Error while viewing file" /></div>
...
<?php
	...
	$checked = ($user->has('roles', $role->id)) ? true : false;	
?>
				<li>
